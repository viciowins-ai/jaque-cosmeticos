...
export default function Home() {
  ...
  return (
    <main className={styles.main}>
      ...
      <a href="https://wa.me/5541997298384?text=Olá%20Jack!%20Vim%20pelo%20site%20e%20quero%20conhecer%20os%20produtos." target="_blank" rel="noopener noreferrer" className={styles.floatingWhatsappBtn}>
